...
public class Test {
    ...
    public static void main(String[] args){
        try {
            ...
            KiteConnect kiteConnect = new KiteConnect("32jmolt11iodnq1f");
            ...
            */
            User user =  kiteConnect.generateSession("80jSRhyX7DeXqfVPXh3QtGx0gkRv3a5X", "hwnri8nhp6kfjbislgaafympuy8cjzgc");
